// ─────────────────────────────────────────────────────────────────────────────
// FILE: components/ReferralCard.tsx  (NEW FILE)
    ...
    <View style={S.card}>
      ...
      <View style={S.header}>
        <View style={S.headerLeft}>
          ...
          <View>
            ...
            <Text style={S.subtitle}>Earn VCoins for every friend who joins</Text>
          </View>
        </View>
      ...
      <View style={S.statsRow}>
        ...
        <View style={S.statBox}>
          ...
          <Text style={S.statLabel}>Per referral</Text>
        </View>
      </View>
      ...
      <View style={S.codeRow}>
        ...
        <TouchableOpacity style={S.copyBtn} onPress={handleCopy} activeOpacity={0.7}>
          ...
          <Text style={[S.copyText, copied && S.copiedText]}>{copied ? "Copied!" : "Copy"}</Text>
        </TouchableOpacity>
      </View>
      ...
      {config.giftEnabled && config.giftLabel ? (
        <View style={S.giftBadge}>
          ...
          <Text style={S.giftText}>Friend also gets: {config.giftLabel}</Text>
        </View>
      ) : null}
      ...
      <TouchableOpacity style={S.shareBtn} onPress={handleShare} activeOpacity={0.85}>
        ...
        <Text style={S.shareBtnText}>Refer More Friends</Text>
      </TouchableOpacity>
    </View>
  );
}
